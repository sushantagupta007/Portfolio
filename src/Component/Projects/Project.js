        ...
        <Container fluid className="bg-secondary p-5" id="project">
            <Container>
                ...
                <Row>
                    ...
                    <Col xs={12} sm={4} className="d-flex justify-content-center justify-content-sm-start">
                        <ProjectCard link="https://dreamy-meninsky-beb1d2.netlify.app" img={Tourist} btn="Make Tour" title="Trave Friend Project" des="Best Tour Planner"></ProjectCard>
                    </Col>
                    <Col xs={12} sm={4} className="d-flex justify-content-center justify-content-sm-start">
                        <ProjectCard link="https://github.com/sushantagupta007/CameraShop" img={Camera} btn="Buy Camera" title="Camera Shop" des="Best Product Available"></ProjectCard>
                    </Col>
                </Row>
            </Container>
